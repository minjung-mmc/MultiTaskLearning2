...
def new_focal_loss(
    ...
    # print("Problem target, onem_targets, pred_prob",targets.shape, onem_targets.shape, pred_prob.shape)
...
def loss_fn(
    ...
    for l in range(levels):
        ...
        cls_losses.append(
            cls_loss.sum()
        )  # FIXME reference code added a clamp here at some point ...clamp(0, 2))
